...
if __name__ == '__main__':
    ...
    yomi_plan_fiducial_ct = transpose_pc(yomi_plan_fiducial_ios, trans_rigid)
    ...
    landmark_ct = np.array([105.6344, 73.6098, 59.5])
    ...
    implant_o = implant_ct[0,:] - 45 * implant_x
    ...
    landmark_fiducial_new = np.vstack((landmark_ct, landmark_ct + 20 * implant_y))
    landmark_fiducial_new = np.vstack((landmark_fiducial_new, landmark_ct + 40 * implant_y))
    landmark_fiducial_new = np.vstack((landmark_fiducial_new, landmark_ct - 40 * implant_y))
    landmark_fiducial_new = np.vstack((landmark_fiducial_new, landmark_ct - 20 * implant_y))
    ...
    draw_registration_result_points_array(ctl_ct, ctl_ios, trans_rigid)
